            ...
            <div v-else class="space-y-2">
                ...
                <div v-else v-for="trip in trips" :key="trip.id"
                    ...
                    <div class="flex justify-between items-start mb-3">
                        ...
                        <!-- invited,owner,admin,participant,pending,requested,declined,can_join -->
                        ...
                        <button v-else-if="trip.isInvited"
...
const fetchTrips = async () => {
    try {
        const data = await $fetch('https://trip-planer-api.sankarsan.xyz/api/trips', {
            method: 'GET',
            headers: {
...
const joinTrip = async (trip) => {
    ...
    try {
        ...
        trip.participant_status = 'requested';
